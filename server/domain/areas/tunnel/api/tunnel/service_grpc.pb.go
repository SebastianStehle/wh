...
func (c *webhookServiceClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ClientMessage, ServerMessage], error) {
...
type WebhookService_SubscribeClient = grpc.BidiStreamingClient[ClientMessage, ServerMessage]
...
func (UnimplementedWebhookServiceServer) Subscribe(grpc.BidiStreamingServer[ClientMessage, ServerMessage]) error {
...
func _WebhookService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WebhookServiceServer).Subscribe(&grpc.GenericServerStream[ClientMessage, ServerMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type WebhookService_SubscribeServer = grpc.BidiStreamingServer[ClientMessage, ServerMessage]
